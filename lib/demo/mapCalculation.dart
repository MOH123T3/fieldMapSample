...
const String API_KEY = "AIzaSyCEXMuVDODjKmphcbP97Bq1tmbYfoVVKuA";
...
class MapSampleState extends State<MapSample> {
  ...
  final polygonCoordinates = [
    ...
    [
      [23.058122830265564, 72.50069338828325],
      [23.05825116214816, 72.50109069049358],
      [23.058349261918195, 72.50139679759741],
      [23.05846679645419, 72.50169519335032],
      [23.05833815628744, 72.50179678201675],
      [23.058214760328507, 72.50184204429388],
    ]
  ];
  ...
  _calculateArea() {
    ...
    print(
        "calculatePolygonArea  $polyPoints  ____________________________=== --------!!!!!!!!!!!!!!!!!  ${polygon.perimeter}");
            ...
            child: Align(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 16.0),
                  ElevatedButton(
                      onPressed: _calculateArea, child: Icon(Icons.av_timer))
                ],
              ),
            ),
          )
